...
import com.andy.wordz.domain.Game;
import com.andy.wordz.domain.GameRepository;
    ...
    public void create(Game game) {
        jdbi.useHandle(handle ->
                handle.createUpdate(SQL_INSERT_NEW_GAME_ROW)
                        .bind("playerName", game.getPlayer().name())
                        .bind("word", game.getTargetWord())
